...
public class Test {
    public static void main(String[] args) {
        System.out.println(StringFormatter.convertAccentsFaster("helo"));
        ...
        //     // tree.add(0, "0");
        //     // tree.add(-1, "-1");
        //     Integer[] a = { 1, 3, 5, 234, 3425, 134124, 54, 1234, 1345534, 12341, 124654, 74545, 63, 634, 3245, 546,
        //             23123476, 345 };
        //     for (Integer i : a) {
        ...
        // float distanceInKM = HaversineDistanceCalculator.inKilometres(52.3838f, -1.560065f, 52.379049f, -1.560898f);
        // System.out.println(distanceInKM);
        // // Calculate distance in miles, should be 0.3 miles
        // float distanceInMiles = HaversineDistanceCalculator.inMiles(52.3838f, -1.560065f, 52.379049f, -1.560898f);
